...
"""Dispatch helpers for invoking registered iterator clauses."""
...
def apply_iterator_clause(
    ...
    **kwargs: Any,
    ...
    Raises:
        AttributeError: If no iterator clause is registered for *clause_name*.
    """
    clause_cls = resolve_iterator_clause(clause_name)
    if clause_cls is None:
        raise AttributeError(f"Unknown iterator clause {clause_name!r}.")
    return clause_cls(builder)(*args, **kwargs)


__all__ = ["apply_iterator_clause"]
